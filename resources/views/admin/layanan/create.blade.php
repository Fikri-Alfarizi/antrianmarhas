...
<div class="card">
    <h3 class="card-title"><i class="fas fa-plus-circle"></i> Tambah Layanan Baru</h3>
    ...
    <form action="{{ route('admin.layanan.store') }}" method="POST">
        ...
        <div class="form-grid">
            <div class="form-group" style="grid-column: span 2;">
                ...
                <input type="text" id="nama_layanan" name="nama_layanan" placeholder="Contoh: Pemeriksaan Umum" required value="{{ old('nama_layanan') }}">
            </div>
            
            <div class="form-group">
                <label for="prefix">Prefix (Kode Awal)</label>
                <input type="text" id="prefix" name="prefix" placeholder="Contoh: A (Maks 5 Karakter)" required value="{{ old('prefix') }}" maxlength="5">
            </div>

            <div class="form-group">
                <label for="digit">Jumlah Digit Angka</label>
                <input type="number" id="digit" name="digit" placeholder="Contoh: 3" required value="{{ old('digit', 3) }}" min="1" max="5">
            </div>
